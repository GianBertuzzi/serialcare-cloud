-- Esquema base no destructivo previo a las migraciones 001-010.
-- Este archivo solo se ejecuta automáticamente cuando no existen tablas de aplicación.
...
CREATE TABLE IF NOT EXISTS productos_modelo (
...
CREATE TABLE IF NOT EXISTS precios_modelo_sucursal (
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_productos_numero_serie ON productos(UPPER(numero_serie));
CREATE UNIQUE INDEX IF NOT EXISTS idx_productos_modelo_codigo ON productos_modelo(UPPER(codigo_comercial)) WHERE codigo_comercial IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_usuarios_id_sucursal ON usuarios(id_sucursal);
CREATE INDEX IF NOT EXISTS idx_clientes_id_sucursal ON clientes(id_sucursal);
CREATE INDEX IF NOT EXISTS idx_clientes_id_usuario ON clientes(id_usuario);
CREATE INDEX IF NOT EXISTS idx_tipos_maquina_id_sucursal ON tipos_maquina(id_sucursal);
CREATE INDEX IF NOT EXISTS idx_productos_id_cliente ON productos(id_cliente);
CREATE INDEX IF NOT EXISTS idx_productos_id_sucursal ON productos(id_sucursal);
CREATE INDEX IF NOT EXISTS idx_productos_id_modelo ON productos(id_modelo);
CREATE INDEX IF NOT EXISTS idx_productos_id_tipo_maquina ON productos(id_tipo_maquina);
CREATE INDEX IF NOT EXISTS idx_repuestos_id_sucursal ON repuestos(id_sucursal);
CREATE INDEX IF NOT EXISTS idx_tipos_reparacion_id_sucursal ON tipos_reparacion(id_sucursal);
CREATE INDEX IF NOT EXISTS idx_precios_modelo_sucursal_id_sucursal ON precios_modelo_sucursal(id_sucursal);
CREATE INDEX IF NOT EXISTS idx_precios_modelo_sucursal_id_modelo ON precios_modelo_sucursal(id_modelo);
CREATE INDEX IF NOT EXISTS idx_ordenes_servicio_id_producto ON ordenes_servicio(id_producto);
CREATE INDEX IF NOT EXISTS idx_ordenes_servicio_id_sucursal ON ordenes_servicio(id_sucursal);
CREATE INDEX IF NOT EXISTS idx_ordenes_servicio_id_cliente ON ordenes_servicio(id_cliente);
CREATE INDEX IF NOT EXISTS idx_ordenes_servicio_id_tipo_maquina ON ordenes_servicio(id_tipo_maquina);
CREATE INDEX IF NOT EXISTS idx_ordenes_servicio_id_tipo_reparacion ON ordenes_servicio(id_tipo_reparacion);
CREATE INDEX IF NOT EXISTS idx_repuestos_usados_id_orden ON repuestos_usados(id_orden);
CREATE INDEX IF NOT EXISTS idx_cotizaciones_id_orden ON cotizaciones(id_orden);
CREATE INDEX IF NOT EXISTS idx_evidencias_orden_id_orden ON evidencias_orden(id_orden);
CREATE INDEX IF NOT EXISTS idx_garantias_id_orden ON garantias(id_orden);
CREATE INDEX IF NOT EXISTS idx_garantias_id_producto ON garantias(id_producto);
CREATE INDEX IF NOT EXISTS idx_garantias_id_sucursal ON garantias(id_sucursal);
